...
public enum ItemManagerConfig {
    ...
    CARD_CATALOG(SColumnUtil.getCatalogDefaultColumns(true), true, false, false,
            null, null, 4, 0),
    CARD_GALLERY(SColumnUtil.getCatalogDefaultColumns(true), true, false, false,
            null, null, 4, 1),
    ...
    CONSTRUCTED_DECKS(SColumnUtil.getDecksDefaultColumns(true, true), false, false, false,
            null, null, 3, 0),
    COMMANDER_DECKS(SColumnUtil.getDecksDefaultColumns(true, false, true), false, false, false,
            null, null, 3, 0),
