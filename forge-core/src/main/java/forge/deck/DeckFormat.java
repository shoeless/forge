...
public enum DeckFormat {
    ...
    Commander      ( Range.between(99, 99),                Range.between(0, 10), 1, null,
            card -> StaticData.instance().getCommanderPredicate().test(card)
    ),
    Oathbreaker      ( Range.between(58, 58),                Range.between(0, 10), 1, null,
            card -> StaticData.instance().getOathbreakerPredicate().test(card)
    ),
    Pauper      ( Range.between(60, 60),                Range.between(0, 10), 1),
    Brawl      ( Range.between(59, 59), Range.between(0, 15), 1, null,
            card -> StaticData.instance().getBrawlPredicate().test(card)
    ),
    TinyLeaders    ( Range.between(49, 49),                Range.between(0, 10), 1, new Predicate<>() {
    ...
    PlanarConquest ( Range.between(40, Integer.MAX_VALUE), Range.between(0, 0), 1),
    Adventure      ( Range.between(40, Integer.MAX_VALUE), Range.between(0, Integer.MAX_VALUE), 4) {
        @Override
    ...
    Vanguard       ( Range.between(60, Integer.MAX_VALUE), Range.between(0, 0), 4),
    Planechase     ( Range.between(60, Integer.MAX_VALUE), Range.between(0, 0), 4),
    Archenemy      ( Range.between(60, Integer.MAX_VALUE), Range.between(0, 0), 4),
    Puzzle         ( Range.between(0, Integer.MAX_VALUE), Range.between(0, 0), 4);
