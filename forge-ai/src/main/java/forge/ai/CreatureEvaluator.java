...
public class CreatureEvaluator implements Function<Card, Integer> {
    ...
    public int evaluateCreature(final Card c, final boolean considerPT, final boolean considerCMC) {
        ...
        // (e.g. Talrand creating Drakes on spell cast, Murmuring Mystic creating Birds). A/B win-rate
        // testing showed a small but consistent positive (~53% on Talrand and Token Triumph mirrors),
