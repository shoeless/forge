    ...
    protected AiAbilityDecision checkApiLogic(Player aiPlayer, SpellAbility sa) {
        ...
        if (aiLogic != null) {
            if (aiLogic.equals("Always")) {
                ...
                CardCollection commanders = CardLists.filter(aiPlayer.getCardsIn(ZoneType.Command), Card::isCommander);
        ...
        while (sa.canAddMoreTarget()) {
            ...
            if (!list.isEmpty()) {
                if (destination.equals(ZoneType.Battlefield) || origin.contains(ZoneType.Battlefield)) {
                    ...
                    // choice==null handling below, matching how DestroyAi guards this same call.
